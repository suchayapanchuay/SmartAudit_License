...
void ReplayTransport::reschedule_timer()
{
    ...
    auto const now = this->time_base.monotonic_time;
...
Transport::TlsResult ReplayTransport::enable_client_tls(CertificateChecker /*certificate_checker*/, TlsConfig const& /*tls_config*/, AnonymousTls /*anonymous_tls*/)
{
    size_t cert_pos;
...
MonotonicTimePoint ReplayTransport::prefetchForTimer()
{
    ...
    return this->time_base.monotonic_time;
}
