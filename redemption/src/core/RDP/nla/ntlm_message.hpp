...
static inline array_md4 Md4(bytes_view data)
{
    ...
    SslMd4 md4;
    md4.update(data);
    md4.final(make_writable_sized_array_view(result));
    return result;
}
...
static inline array_md5 Md5(u8_array_view data)
{
    ...
    SslMd5 md5;
    md5.update(data);
    md5.final(make_writable_sized_array_view(result));
    return result;
}
...
static inline array_md5 HmacMd5(u8_array_view key, u8_array_view data)
{
    ...
    hmac_md5.final(make_writable_sized_array_view(result));
    return result;
}
...
static inline array_sha256 Sha256(bytes_view data1, u8_array_view data2, u8_array_view data3)
{
    ...
    sha256.update(data2);
    sha256.update(data3);
    sha256.final(make_writable_sized_array_view(result));
    return result;
}
