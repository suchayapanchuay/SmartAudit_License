...
from license_server.models.customer import Customer
from license_server.models.product import Product
from license_server.models.order import Order

from license_server.utils.events import publish  # ล้มให้รู้ ถ้า import ไม่ได้
