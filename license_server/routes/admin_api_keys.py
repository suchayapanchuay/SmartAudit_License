...
from license_server.models.api_key import ApiKey, KeyStatus
from license_server.schemas.api import ApiKeyCreateIn, ApiKeyCreatedOut, ApiKeyListItem
from license_server.security.api_keys import generate_plain_key, sha256_hex, mask_from
from license_server.services.activities import log_activity  # <= helper บันทึก log
