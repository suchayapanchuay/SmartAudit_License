...
RED_JS_AUTO_TEST_CASE(
    ...
    RED_CHECK(to_data_url(canvas) == "data:image/png;base64,"
        "iVBORw0KGgoAAAANSUhEUgAAAZAAAAEsCAIAAABi1XKVAAAABmJLR0QA/wD/AP+gvaeTA"
        "AAD6ElEQVR4nO3dQWrDQBBFQcv4/ldWDhAMCrQzeuOqA4jR5tG7fzzOx5hj7lMAvzxXPw"
        "DgKsECMgQLyBAsIEOwgAzBAjIEC8gQLCBDsIAMwQIyBAvIECwgQ7CADMECMgQLyBAsIEO"
        "wgAzBAjIEC8gQLCBDsIAMwQIyBAvIECwgY3T79BwcZZ1z2HeFTbiwgAzBAjIEC8gQLCBD"
        "sIAMwQIyBAvIECwgQ7CADMECMgQLyBAsIEOwgAzBAjIEC8gQLCBDsIAMwQIyBAvIECwgQ"
        "7CADMECMgQLyBAsIOMLhlQH2WSFpVxYQIZgARmCBWQIFpAhWECGYAEZggVkCBaQIVhAhm"
        "ABGYIFZAgWkCFYQIZgARmCBWQIFpAhWECGYAEZggVkCBaQIVhAhmABGYIFZAgWkHHXZdB"
        "bbrKeg0Oqt/xBljgM9F7mwgIyBAvIECwgQ7CADMECMgQLyBAsIEOwgAzBAjIEC8gQLCBD"
        "sIAMwQIyBAvIECwgQ7CADMECMgQLyBAsIEOwgAzBAjIEC8gQLCBDsICM1+oHvLH9ZOn2P"
        "wgf4MICMgQLyBAsIEOwgAzBAjIEC8gQLCBDsIAMwQIyBAvIECwgQ7CADMECMgQLyBAsIE"
        "OwgAzBAjIEC8gQLCBDsIAMwQIyBAvIECwgQ7CAjLk5zy+w/2CpTdYVjsFV3d25sIAMwQI"
        "yBAvIECwgQ7CADMECMgQLyBAsIEOwgAzBAjIEC8gQLCBDsIAMwQIyBAvIECwgQ7CADMEC"
        "MgQLyBAsIEOwgAzBAjIEC8gQLCDjtfoBKYM7o7Yz4e9cWECGYAEZggVkCBaQIVhAhmABG"
        "YIFZAgWkCFYQIZgARmCBWQIFpAhWECGYAEZggVkCBaQIVhAhmABGYIFZAgWkCFYQIZgAR"
        "mCBWQIFpBhSHWRwU1WVhhcwrXPe50LC8gQLCBDsIAMwQIyBAvIECwgQ7CADMECMgQLyBA"
        ...
        "CwgQ7CADMECMgQLyBAsIEOwgAzBAjIECwAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
        "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAADg3xyrHwBs7pz71HPuUwCfJVhAhmA"
        "BGYIFZAgWkCFYQIZgARmCBWQIFpAhWECGYAEZggVkCBaQIVhAhmABGYIFZAgWkCFYQIZg"
        "ARmCBWQIFpAhWECGYAEZggVk/ADuAhn0ru7WAAAAAABJRU5ErkJggg=="_av);


    // RDPScrBlt
    {
        // Copy inserted zone to 0,0
