...
# from utils.settings import settings  # ใช้ APP_NAME, PORTAL_URL
# from utils.passwords import hash_password

# from core.email_smtp import send_email_smtp  # ใช้ SMTP ใหม่
...
#     # เตรียมเนื้อหาเมล (ตอนนี้ใช้ SMTP กลาง)
...
#     # ส่งผ่าน SMTP เดียวกับระบบ (background task)
#     background.add_task(
#         send_email_smtp,
#         to=client.email,
#         subject=subject,
#         body=html_body,  # ถ้าอยากส่งเป็น plain text → เปลี่ยนเป็น text_body และ as_html=False
#         as_html=True,
#     )
